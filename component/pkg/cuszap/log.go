...
func New(opts *Options) *zapLogger {
	...
	var err error
	l, err := loggerCofig.Build(zap.AddStacktrace(zapcore.PanicLevel), zap.AddCallerSkip(1))
	if err != nil {
		panic(err)
	}
	logger := &zapLogger{
...
// Error method output errors level log.
...
// Errorf method output errors level log.
...
// Errorw method output errors level log.
