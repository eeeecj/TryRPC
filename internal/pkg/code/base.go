...
const (
	...
	// ErrUnknown - 500: Internal server errors.
	ErrUnknown
...
const (
	// ErrDatabase - 500: Database errors.
...
const (
	// ErrEncodingFailed - 500: Encoding failed due to an errors with the data.
	ErrEncodingFailed int = iota + 100301

	// ErrDecodingFailed - 500: Decoding failed due to an errors with the data.
	ErrDecodingFailed
